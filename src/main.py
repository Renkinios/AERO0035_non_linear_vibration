...
VT.VizASM(relative_displacement, relative_speed, neg_acceleration, speed0_bool = False)
VT.VizASM(relative_displacement, relative_speed, neg_acceleration, speed0_bool = True)
